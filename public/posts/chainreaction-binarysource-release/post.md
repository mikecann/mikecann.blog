...
The tool lets an artist or designer visually lay out their effect in an easy to use and understand manner. Once an effect has been created it can be exported out to either the XNA SDK or the [Flash SDK](/flash/winter.html) for a programmer to use in thier own projects:
